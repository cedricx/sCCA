...
p3Km111.cca<-mclapply(seq_along(trainid),function(i) ccaDW(brain_train[[i]],behavior_train[[i]],0.8,0.4,20))
p3Km111.cca.ro <- sapply(p3Km111.cca,function(x) reorderCCA(x,p3Km111.cand,20))
...
p3Km111.perm.cca<-sapply(behavior.perm, function(y_perm){ out<-ccaDWpermorder(data$brain,y_perm,0.8,0.4,candnum,p3Km111.cand)} )
