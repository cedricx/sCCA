...
lau_train_net <- sample_net
save(lau_train_net, file ="./result/201701/lau_train_netmat.RData")
```
...
lau_train_net_ft <- net_ft
save(lau_train_net_ft,file ="./result/201701/lau_train_net_ft.RData")
```
...
lau_train_ave <- net_ave


parcels <- read.csv('/data/joy/BBL/studies/pnc/n1601_dataFreeze2016/neuroimaging/rest/restNetwork_Lausanne125/Parcels_Lau_125.csv')
parcelshem <- parcels[order(parcels$Hem,parcels$scale125.labels),]

lau_train_ave <- lau_train_ave[parcelshem$scale125.ID,parcelshem$scale125.ID]
save(lau_train_ave, file = "./result/201701/lau_train_ave.RData")

levelplot(lau_train_ave, at = seq(-1,1,length=10),par.settings = BuRdTheme(),xlab='',ylab='',main="Laussane125 Rest")
```
